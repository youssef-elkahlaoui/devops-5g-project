...
\begin{titlepage}
    ...
    % --- Titres ---
    {\Huge\bfseries Analyse Comparative et Automatisation DevOps des Cores 4G et 5G vers le Cloud-Native \par}
    \vspace{1cm}
    {\Large\bfseries Migration Infrastructurelle Multi-Instance, Orchestration et Monitoring sous Open5GS sur Google Cloud Platform\par}
    \vspace{3cm}
    
    % --- Informations ---
    {\Large Auteurs :\par}
    \vspace{0.3cm}
    {\large Anass Essafi~\cite{essafi}\par}
    {\large Ayoub Gorry~\cite{gorry}\par}
    {\large Youssef El Kahlaoui~\cite{elkahlaoui}\par}
    ...
    {\large Transformation Digitale et Intelligence Artificielle \par}
    \vspace{1cm}
    
    {\Large Encadrant :\par}
    \vspace{0.3cm}
    {\large Professeur A. Bahri~\cite{bahri}\par}
    \vspace{1cm}
...
\begin{figure}
    \centering
    \includegraphics[width=0.80\linewidth]{WhatsApp Image 2025-12-26 at 2.57.35 PM (1).jpeg}
    \caption{Schéma détaillé de l’architecture Open5GS 4G EPC}
...
\begin{figure}
    ...
    \caption{Schéma détaillé de l'architecture Open5GS 5G Core} % Ce titre va dans la Liste des Figures
    \label{fig:placeholder}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{Untitled design.png}
    \caption{Architecture Finale de VPC et relations entre service}
    \label{fig:placeholder}
\end{figure}
...
\begin{figure}
    ...
    \caption{Architecture explicative du rôle de reverse proxy Nginx}
    \label{fig:placeholder}
\end{figure}
...
% Auteurs et Encadrant (insérés en tête de bibliographie)

\bibitem{essafi} Anass Essafi. Auteur — Étudiant en Transformation Digitale et Intelligence Artificielle, École Nationale des Sciences Appliquées (ENSA) - Al Hoceima.

\bibitem{gorry} Ayoub Gorry. Auteur — Étudiant en Transformation Digitale et Intelligence Artificielle, École Nationale des Sciences Appliquées (ENSA) - Al Hoceima.

\bibitem{elkahlaoui} Youssef El Kahlaoui. Auteur — Étudiant en Transformation Digitale et Intelligence Artificielle, École Nationale des Sciences Appliquées (ENSA) - Al Hoceima. Portfolio:
\url{https://youssef-elkahlaoui.rf.gd/}.
\bibitem{bahri} Professeur Abdelkhalek BAHRI . Encadrant — Professeur, École Nationale des Sciences Appliquées (ENSA) - Al Hoceima.
